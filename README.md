...
- ~~!leaderboard should find the months leaderboard and parse it into a nice discord table message~~
- ~~NOT POSSIBLE\*!leaderboard should only send the message to be recieved by the person who called the command~~
